...
(function(n, t) {
	...
	function fu(n, t) {
		if (t in n) return t;
		for (var r = t.charAt(0).toUpperCase() + t.slice(1), u = t, i = uu.length; i--;) if (t = uu[i] + r, t in n) return t;
		return u
	}
	function ut(n, t) {
	...
	function rf(n, t, r) {
		var e, o, s = 0,
			...
			h = u.props;
		for (bo(h, u.opts.specialEasing); s < l; s++) if (e = yt[s].call(u, n, h, u.opts), e) return e;
	...
	function ko(n, t, r) {
		...
		if (v = w.length, v) for (s = i._data(n, "fxshow") || i._data(n, "fxshow", {}), ("hidden" in s) && (c = s.hidden), y && (s.hidden = !c), c ? i(n).show() : h.done(function() {
			i(n).hide()
		}), h.done(function() {
			var t;
		...
		init: function(n, u, f) {
			...
			if (typeof n == "string") {
				if (e = n.charAt(0) === "<" && n.charAt(n.length - 1) === ">" && n.length >= 3 ? [null, n, null] : cf.exec(n), e && (e[1] || !u)) {
					if (e[1]) {
						if (u = u instanceof i ? u[0] : u, i.merge(this, i.parseHTML(e[1], u && u.nodeType ? u.ownerDocument || u : r, !0)), di.test(e[1]) && i.isPlainObject(u)) for (e in u) i.isFunction(this[e]) ? this[e](u[e]) : this.attr(e, u[e]);
						return this
					}
	...
	i.extend = i.fn.extend = function() {
		var u, o, r, e, s, h, n = arguments[0] || {},
			...
			l = arguments.length,
			c = !1;
		for (typeof n == "boolean" && (c = n, n = arguments[1] || {}, f = 2), typeof n == "object" || i.isFunction(n) || (n = {}), l === f && (n = this, --f); f < l; f++) if ((s = arguments[f]) != null) for (e in s)(u = n[e], r = s[e], n !== r) && (c && r && (i.isPlainObject(r) || (o = i.isArray(r))) ? (o ? (o = !1, h = u && i.isArray(u) ? u : []) : h = u && i.isPlainObject(u) ? u : {}, n[e] = i.extend(c, h, r)) : r !== t && (n[e] = r));
		return n
	};
	i.extend({
		...
		map: function(n, t, i) {
			var u, r = 0,
				...
				o = dt(n),
				f = [];
			if (o) for (; r < e; r++) u = t(n[r], r, i), u != null && (f[f.length] = u);
	...
	i.fn.extend({
		...
		addClass: function(n) {
			...
			if (c) for (e = (n || "").match(s) || []; f < h; f++) if (t = this[f], r = t.nodeType === 1 && (t.className ? (" " + t.className + " ").replace(ti, " ") : " "), r) {
		...
		removeClass: function(n) {
			...
			if (c) for (e = (n || "").match(s) || []; f < h; f++) if (r = this[f], t = r.nodeType === 1 && (r.className ? (" " + r.className + " ").replace(ti, " ") : ""), t) {
		...
		toggleClass: function(n, t) {
			...
			return i.isFunction(n) ? this.each(function(r) {
				...
				if (r === "string") for (var f, c = 0, h = i(this), e = t, l = n.match(s) || []; f = l[c++];) e = u ? e : !h.hasClass(f), h[e ? "addClass" : "removeClass"](f);
	...
	i.extend({
		...
		attr: function(n, r, u) {
			...
			if (n && h !== 3 && h !== 8 && h !== 2) {
				...
				if (s = h !== 1 || !i.isXMLDoc(n), s && (r = r.toLowerCase(), f = i.attrHooks[r] || (er.test(r) ? fr : k)), u !== t) if (u === null) i.removeAttr(n, r);
		...
		removeAttr: function(n, t) {
			var r, u, e = 0,
				f = t && t.match(s);
			if (f && n.nodeType === 1) while (r = f[e++]) u = i.propFix[r] || r, er.test(r) ? !a && ii.test(r) ? n[i.camelCase("default-" + r)] = n[u] = !1 : n[u] = !1 : i.attr(n, r, ""), n.removeAttribute(a ? r : u)
		},
		attrHooks: {
			type: {
				set: function(n, t) {
	...
	i.fn.extend({
		...
		function ri(n, t, i) {
			...
			function(t, i, f) {
				...
				} else while (t = t[r]) if (t.nodeType === 1 || u) if (c = t[f] || (t[f] = {}), (s = c[r]) && s[0] === l) {
		...
		function ei(n) {
			...
			}]; t < o; t++) if (u = r.relative[n[t].type]) e = [ri(ui(e), u)];
			else {
		...
		it = u.setDocument = function(n) {
			...
			function(n, t) {
				...
				ct.call(n, "[s!='']:x");
				rt.push("!=", gt)
			}), a = new RegExp(a.join("|")), rt = new RegExp(rt.join("|")), et = ti(h.contains) || h.compareDocumentPosition ?
			function(n, t) {
		...
		r = u.selectors = {
					...
					function(n) {
						...
						if (p) {
							...
							if (w = [o ? p.firstChild : p.lastChild], o && d) {
								for (k = p[f] || (p[f] = {}), a = k[n] || [], y = a[0] === v && a[1], l = a[0] === v && a[2], c = y && p.childNodes[y]; c = ++y && c && c[b] || (l = y = 0) || w.pop();) if (c.nodeType === 1 && ++l && c === t) {
									k[n] = [v, y, l];
									break
								}
			...
			pseudos: {
				...
				lang: l(function(n) {
					return nr.test(n || "") || u.error("unsupported lang: " + n), n = n.replace(p, w).toLowerCase(), function(t) {
						var i;
						do
	...
	i.fn.extend({
		...
		domManip: function(n, r, f) {
			...
			if (a && (h = i.buildFragment(n, this[0].ownerDocument, !1, this), c = h.firstChild, h.childNodes.length === 1 && (h = c), c)) {
				...
				if (l) for (y = s[s.length - 1].ownerDocument, i.map(s, gr), o = 0; o < l; o++) e = s[o], kr.test(e.type || "") && !i._data(e, "globalEval") && i.contains(y, e) && (e.src ? i.ajax({
					url: e.src,
					type: "GET",
					dataType: "script",
					async: !1,
	...
	i.extend({
		clone: function(n, t, r) {
			...
			if (i.support.html5Clone || i.isXMLDoc(n) || !yr.test("<" + n.nodeName + ">") ? o = n.cloneNode(!0) : (oi.innerHTML = n.outerHTML, oi.removeChild(o = oi.firstChild)), (!i.support.noCloneEvent || !i.support.noCloneChecked) && (n.nodeType === 1 || n.nodeType === 11) && !i.isXMLDoc(n)) for (f = u(o), s = u(n), e = 0;
			(h = s[e]) != null; ++e) f[e] && pe(h, f[e]);
			if (t) if (r) for (s = s || u(n), f = f || u(o), e = 0;
			(h = s[e]) != null; e++) nu(h, f[e]);
			else nu(n, o);
			return f = u(o, "script"), f.length > 0 && si(f, !c && u(n, "script")), f = s = h = null, o
		},
		buildFragment: function(n, t, r, f) {
			for (var h, o, w, s, y, p, l, b = n.length, a = ar(t), c = [], v = 0; v < b; v++) if (o = n[v], o || o === 0) if (i.type(o) === "object") i.merge(c, o.nodeType ? [o] : o);
			else if (se.test(o)) {
				...
				if (!i.support.leadingWhitespace && fi.test(o) && c.push(t.createTextNode(fi.exec(o)[0])), !i.support.tbody) for (o = y === "table" && !br.test(o) ? s.firstChild : l[1] === "<table>" && !br.test(o) ? s : 0, h = o && o.childNodes.length; h--;) i.nodeName(p = o.childNodes[h], "tbody") && !p.childNodes.length && o.removeChild(p);
				for (i.merge(c, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
				s = a.lastChild
			} else c.push(t.createTextNode(o));
			for (s && a.removeChild(s), i.support.appendChecked || i.grep(u(c, "input"), we), v = 0; o = c[v++];) if ((!f || i.inArray(o, f) === -1) && (w = i.contains(o.ownerDocument, o), s = u(a.appendChild(o), "script"), w && si(s), r)) for (h = 0; o = s[h++];) kr.test(o.type || "") && r.push(o);
			return s = null, a
		},
		cleanData: function(n, t) {
			for (var r, e, u, f, c = 0, s = i.expando, h = i.cache, l = i.support.deleteExpando, a = i.event.special;
			(r = n[c]) != null; c++) if ((t || i.acceptData(r)) && (u = r[s], f = u && h[u], f)) {
			...
			var l, a, e, d, g, y, v, p, u = i.ajaxSetup({}, r),
				...
				f = {
					...
					statusCode: function(n) {
						var t;
						if (n) if (o < 2) for (t in n) b[t] = [b[t], n[t]];
			...
			return {
				send: function(f, e) {
					...
					u = function(n, f) {
						var s, a, l, c;
						try {
							if (u && (f || o.readyState === 4)) if (u = t, h && (o.onreadystatechange = i.noop, at && delete g[h]), f) o.readyState !== 4 && o.abort();
							else {
								c = {};
								s = o.status;
	...
	function r(i) {
		e[i] || (e[i] = !0, n.migrateWarnings.push(i), t.console && console.warn && !n.migrateMute && (console.warn("JQMIGRATE: " + i), n.migrateTrace && console.trace && console.trace()))
	}
	function o(t, i, u, f) {
	...
	n.fn.init = function(t, i, u) {
		var f;
		return t && typeof t == "string" && !n.isPlainObject(i) && (f = et.exec(t)) && f[1] && (t.charAt(0) !== "<" && r("$(html) HTML strings must start with '<' character"), i && i.context && (i = i.context), n.parseHTML) ? c.call(this, n.parseHTML(n.trim(t), i, !0), i, u) : c.apply(this, arguments)
	};
...
var KEY_UP = 38,
	...
	retryCount = 3,
	isReceived = !1,
	sslTimer, useMCS = navigator.userAgent.match(/Trident.*rv\:11\./) ? !1 : !$.browser.msie,
...
Array.prototype.appendFormatEx = function(n) {
	var i, t, r;
	for (this._parameters == null && (this._parameters = []), i = this._convertToArray(arguments).slice(1), t = 0, r = i.length; t < r; t++) this._parameters[this._parameters.length] = i[t];
	this[this.length] = n
};
Array.prototype.toString = function() {
	var i = this._parameters != null,
		r, n, t, u;
	if (i = i && this._parameters.length > 0, i) {
		for (r = this.join("").split("?"), n = [], t = 0, u = r.length; t < u; t++) n[n.length] = r[t], n[n.length] = this._parameters[t];
		return n.join("")
	}
	return this.join("")
};
...
var utility = {
	...
	template: function(n, t, i) {
		var r, u, f, e;
		if (this.isConsoleLogTemplate && console.log("[utility.template] templateUrl = " + n + ", key = " + i), i && (u = this.templateCache[i], u)) {
			r = TrimPath.parseTemplate(u);
			this.isConsoleLogTemplate && console.log("[utility.template] Get from templateCache. key = " + i);
			t(r);
			return
		}(f = window.location.host != "localhost:288" ? "/Public/Templates/" + n + "?v=" + global.rv : "/Public/Templates/" + n + "?v=" + (new Date).getTime(), e = !0, (n.indexOf("_1024") != -1 || n.indexOf("_1280") != -1) && (e = !1), utility.stopRequest) || $.ajax({
			url: f,
			cache: !0,
			type: "GET",
			success: function(n) {
	...
	templateFromPage: function(n, t, i) {
		var r, u;
		if (n = n.split("/")[1], n = "tmpl" + n.replace(".html", ""), this.isConsoleLogTemplate && console.log("[utility.template] templateId = " + n + ", key = " + i), i && (r = this.templateCache[i], r)) {
			this.isConsoleLogTemplate && console.log("[utility.template] Get from templateCache. key = " + i);
			t(r);
			return
		}
	...
	service: function(n, t, i, r, u, f, e) {
		if (!utility.stopRequest) {
			...
			var o = this.objToPostString(i),
				s = "/" + global.lan + "/Service/" + n + "?" + t + "&ts=" + (new Date).getTime();
			utility.currentRequest = $.ajax({
				...
				beforeSend: function(n, t) {
					utility.currentRequest && utility.currentRequest.readyState != 4 && utility.currentRequestUrl.indexOf("CentralService?") != -1 && t.url.indexOf("CentralService?") != -1 && (utility.currentRequest.abort(), utility.currentRequest = null, console.log("Abort previous ajax request!"));
			...
			utility.currentRequestUrl.indexOf("CentralService?") != -1 && i.IsFirstLoad && (utility.abortTimer = setTimeout(function() {
				utility.currentRequest ? (console.log("Abort current ajax request!"), alert("Request timeout. Issue a new request."), utility.currentRequest.abort(), utility.currentRequest = null, utility.service(n, t, i, r, u, f, e)) : console.log("ajax call completed in time")
			}, 3e4))
		}
	},
	...
	succeededAction: function(response, callBack, excludeLanguage) {
		var data, parsed = !1;
		try {
			response && response != "" ? (typeof response == "object" ? data = response : eval("data =" + response), !excludeLanguage && window.l && (data.$l = window.l), parsed = !0) : parsed = !1
		} catch (e) {
	...
	objToPostString: function(n, t) {
		...
		t || (t = "");
		r = [];
		for (i in n) if (n[i] != undefined && n[i] != null) if (n[i] instanceof Array) for (f = n[i], u = 0; u < f.length; u++) r.push(t + i + "=" + f[u]);
		else typeof n[i] == "object" ? r.push(this.objToPostString(n[i], i + ".")) : r.push(t + i + "=" + encodeURIComponent(n[i]));
		return r.join("&")
	},
	...
	parseToSizeInfo: function(n) {
		...
		return (typeof u == "undefined" || u.toLowerCase() != "no") && (u = "yes"), (typeof r == "undefined" || r.toLowerCase() != "yes") && (r = "no"), (isNaN(f) || isNaN(e)) && pm.showParentAlert(global.tLogin, "Error:" + n), {
			id: o,
			width: f,
			height: e,
			scroll: u,
	...
	popupNewWin: function(n, t, i, r) {
		...
		(i == "_blank" && (i = "188BET"), i || (i = "188BET"), u && u.id && (i = u.id), utility.popupUrlWin(t.href, u, i), r && r == !0) || (n.stopPropagation(), n.preventDefault())
	},
	ttip: function(n) {
		$(n).tt({
			showEvent: "mouseover",
	...
	getParentScrollTop: function() {
		try {
			return $parentDocument === undefined && ($parentDocument = parent.$(parent.document)), $parentDocument.scrollTop()
		} catch (n) {
	...
	getParentWindowHeight: function() {
		try {
			return $parentWindow === undefined && ($parentWindow = parent.$(parent.window)), $parentWindow.height()
		} catch (n) {
	...
	getParentHeaderHeight: function() {
		var n;
		return n = global.bu == "188BET" || global.bu == "SB1888" ? "#HeadContainer" : ".header-c", $(parent.document) ? $(parent.document).find(n).first().outerHeight() : 0
	},
	getParentFooterHeight: function() {
		var n;
		return n = global.bu == "188BET" || global.bu == "SB1888" ? "#footer" : "#footer", $(parent.document) ? $(parent.document).find(n).first().outerHeight() : 0
	},
	...
	HomeJS = {
		...
		ajaxLoading: function(n) {
			var t = $("#ajxldg");
			n ? (HomeJS.isP = !0, t.length <= 0 && ($("#preLogin").addClass("hidden"), $("#TitleForgotPass").addClass("hidden"), $("<div id='ajxldg' class='ajxldg'/>").insertAfter("#preLogin")), HomeJS.timeOutId ? clearTimeout(HomeJS.timeOutId) : HomeJS.timeOutId = setTimeout("document.location.reload()", 12e4)) : ($("#preLogin").removeClass("hidden"), t.remove(), HomeJS.isP = !1, $("#TitleForgotPass").removeClass("hidden"), HomeJS.timeOutId && clearTimeout(HomeJS.timeOutId))
		},
	...
	TimeZone = {
		...
		initTz: function(n) {
			...
			var u = new Date,
				...
				r = utility.cookie.read("timeZone");
...
$(function() {
	...
	document.oncontextmenu = function(n) {
		...
		var t = n ? n.target : event.srcElement,
			i = t.nodeName;
...
window.Modernizr = function(n, t, i) {
	...
	var r = {},
		...
		a = [],
		v = a.slice,
		o, b = function(n, i, r, e) {
			var l, a, c, v, o = t.createElement("div"),
				h = t.body,
				s = h || t.createElement("body");
			if (parseInt(r, 10)) while (r--) c = t.createElement("div"), c.id = e ? e[r] : f + (r + 1), o.appendChild(c);
			return l = ["&#173;", '<style id="s', f, '">', n, "<\/style>"].join(""), o.id = f, (h ? o : s).innerHTML += l, s.appendChild(o), h || (s.style.background = "", s.style.overflow = "hidden", v = u.style.overflow, u.style.overflow = "hidden", u.appendChild(s)), a = i(o, n), h ? o.parentNode.removeChild(o) : (s.parentNode.removeChild(s), u.style.overflow = v), !! a
		},
		y = {}.hasOwnProperty,
		p, h;
	p = s(y, "undefined") || s(y.call, "undefined") ?
	function(n, t) {
	...
	Function.prototype.bind || (Function.prototype.bind = function(n) {
		...
		return i = v.call(arguments, 1), r = function() {
			var f, e, u;
			return this instanceof r ? (f = function() {}, f.prototype = t.prototype, e = new f, u = t.apply(e, i.concat(v.call(arguments))), Object(u) === u) ? u : e : t.apply(n, i.concat(v.call(arguments)))
		}, r
	});
	e.touch = function() {
		var i;
	...
	return r.addTest = function(n, t) {
		if (typeof n == "object") for (var f in n) p(n, f) && r.addTest(f, n[f]);
		else {
		...
		return r
	}, k(""), w = g = null, r._version = "2.6.2", r._prefixes = l, r.testStyles = b, u.className = u.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (c ? " js " + a.join(" ") : ""), r
}(this, this.document);
Control = {};
Control.Dialog = {
	...
	_render: function(n, t, i) {
		var r = [];
		return r.push('<div id="' + this._dialogID + '" title="' + t + '">'), r.push("<table id='_dlgct'><tr><td valign='top'>"), r.push('<span class="' + n + ' ui-icon ui-icon-circle-check"><\/span>'), r.push("<\/td><td valign='middle'>"), r.push(i), r.push("<\/td><\/tr><\/table>"), r.push("<\/div>"), $(r.join(""))
	},
	_render_Splash: function(n, t, i) {
		var r = [];
		return r.push('<div id="' + this._dialogID + '" title="' + t + "\" style='margin:5px 10px'>"), r.push(i), r.push("<\/div>"), $(r.join(""))
	},
	_showDialog: function(n, t, i, r) {
		var h = function() {
				var n = ($(window).width() - u.outerWidth()) / 2,
					t = $(window).height() > u.outerHeight() ? ($(window).height() - u.outerHeight()) / 2 : 10;
				u.css({
					top: t,
					left: n
				})
			},
			c = n && n.toString().length > 0 ? "icon-" + n : "icon-" + this.type.Information,
			l = {},
			e, s;
		...
		var a = n == Control.Dialog.type.Splash ? this._render_Splash(c, t, i) : this._render(c, t, i),
			f = n == Control.Dialog.type.Prompt ? 785 : n == Control.Dialog.type.Splash ? 840 : 260,
			o = $(window).height();
		a.dialog({
			modal: !0,
			resizable: !1,
		...
		var u = a.parent("div.ui-dialog"),
			v = o > u.outerHeight() ? (o - u.outerHeight()) / 2 : 10,
			y = $(window).width() > f ? ($(window).width() - f) / 2 : 10;
		...
		n == Control.Dialog.type.Prompt && (u.find("table#_dlgct tr td:eq(0)").remove(), e = u.find("div.ui-dialog-buttonpane"), s = e.find("button:eq(2)"), e.append("<span class='btnright'>" + s.text() + "<input type='checkbox' id='ckbDontShow' /input><\/span>"), e.find("button").css({
			float: "left"
...
Control.Select = {
	...
	init: function(n, t) {
		function v() {
			i.text.dropdown({
				...
				onShowed: function() {
					i.isAnimating = !1;
					i.list.is(":visible") && ((typeof i._selectedIndex == "undefined" || i._selectedIndex < 0) && (i._selectedIndex = parseInt(i.attr("selectedIndex"))), i._selectedIndex >= 0 && i._allLinks.removeClass("focus").eq(i._selectedIndex).addClass("focus"), i.text.focus(), y(), s(i._selectedLink))
				}
			});
		...
		function u(n) {
			var n = f(n);
			n != i._selectedIndex && (i._selectedIndex = n, i._selectedLink = i._allLinks.eq(i._selectedIndex), r = i._selectedIndex, o(i._selectedLink))
		}
		function e(n) {
			var n = f(n),
				t;
			n != r && (r = n, t = i._allLinks.eq(r), i._allLinks.removeClass("focus"), t.addClass("focus"), s(t))
		}
		function w() {
			e(r - 1)
		}
		...
		function s(n) {
			var t = $("ul", i.list),
				u = t.scrollTop(),
				r = (n.offset() ? n.offset().top : 0) + t.scrollTop() - t.offset().top;
		...
		return t = $.extend({
			...
			disabled: !1,
			dropShadow: !0
		}, t), l = n.id, i = Control.Select._build.apply(n, [t]), i._allLinks = $("li > a", i.list), i._selectedIndex = f(i._selectedIndex), i._selectedLink = i._allLinks.eq(i._selectedIndex), r = i._selectedIndex, a = i._selectedLink, v(), i
	},
	select: function(n, t) {
		var i = Control.Select.selectCache[n],
			r = i.text,
			u = i.list,
			f = $("a", u).each(function(n) {
	...
	_build: function(n) {
		var c = "",
			...
			l = 0,
			s, t, h, f, r, i, o;
		if (e.push("<div class='ddl-list' id='" + Control.Select.List_Prefix + u + "'><ul>"), this.options.length == 0 ? c = Control.Select._buildHeader.apply(this, [u, n.disabled]) : (s = 0, $("option", $(this)).each(function() {
			$(this).is(":selected") && (c = Control.Select._buildHeader.apply(this, [u, n.disabled]), l = s);
			...
			s++
		})), e.push("<\/ul><\/div>"), $(this).after(c), $(document.body).append(e.join("")), this.id = "fake_" + u, t = $("#" + u), t._selectedIndex = l, t.text = $("#" + Control.Select.Text_Prefix + u), t.list = $("#" + Control.Select.List_Prefix + u), t.options = n, t._allLinks = $("li > a", t.list), Control.Select.selectCache[u] = t, this.className && t.text.addClass(this.className), $(this).attr("title") && t.text.attr("title", $(this).attr("title")), this.onfocus && t.text.bind("focus", this.onfocus), this.onclick && t.text.bind("click", this.onclick), this.onchange && t.bind("change", this.onchange), h = $.data(this, "events"), h) {
	...
	remove: function(n, t) {
		var i = Control.Select.selectCache[n],
			r;
		i != null && ((r = $("ul > li", i.list), t < 0 || t > r.length - 1) || (t == i._selectedIndex && (i.text.text(" - "), i.val("").trigger("change"), i._selectedIndex = -1), r.eq(t).remove()))
	},
	removeAll: function(n) {
		var t = Control.Select.selectCache[n],
			i;
		t != null && (i = $("ul > li", t.list).remove(), t._selectedIndex >= 0 && (t.text.text(" - "), t._selectedIndex = -1))
	},
	...
	addItems: function(n, t, i) {
		var r, o, u, e, f, s;
		if (t != null && t.length != 0 && (r = Control.Select.selectCache[n], r != null)) if (o = r.options, u = "Control.Select._buildItem.apply(this)", o && o.type == "link" && (u = "Control.Select._buildLinkItem.apply(this)"), e = $("ul > li", r.list), f = null, i) if (e.length == 0 && i == 0) f = $("ul", r.list), $(t).each(function() {
			f.append(eval(u))
		});
		...
		else f = $("ul", r.list), $(t).each(function() {
			f.append(eval(u))
		})
	},
	refresh: function(n) {
		var t = Control.Select.selectCache[n],
			i;
		t != null && (t.list = $("#" + Control.Select.List_Prefix + n), t._allLinks = $("li > a", t.list), i = $("li > a.focus", t.list), i.length > 0 && (t.text = $("#" + Control.Select.Text_Prefix + n), t.text.html(i.text()), t.val(i.val()), t.attr("selectedIndex", $("li > a", t.list).index(i))), Control.Select.selectCache[n] = t)
	},
...
Control.DDL = {
	buildItem: function(n, t, i) {
		var r = new StringBuilderEx,
			u = i ? "data-sel" : "";
		return r.appendFormat('<li><a href="javascript:void(0)" data-val="{0}" {2}>{1}<\/a><\/li>', t, n, u), r.toString()
	},
	buildItem2: function(n, t, i) {
		var r = new StringBuilderEx,
			u = i ? "data-sel" : "";
		return r.appendFormat('<li><span data-val="{0}" {2}>{1}<\/span><\/li>', t, n, u), r.toString()
	}
};
pm = {
	createNew: function() {
		var t = document.referrer.match(/(?:[(http|https)\://])*[^\/]*/)[0],
			n = function(n) {
			...
			e = function() {
				...
				try {
					...
					self != window.top && (u = "", isIE9AndBelow ? (t = window.location.hash, t != "" ? (f = t.indexOf("?"), r = f > -1 ? i(t.substr(f)) : "", e = f == -1 ? t.substr(1, t.length) : t.substr(1, f - 1), u = e + r) : u = window.location.pathname + r) : u = window.location.pathname + r, n({
						topic: "setHistory",
						data: {
							title: "",
							url: u
			...
			i = function(n) {
				var e, r, u, f, t = "",
					i;
				if (n.length > 0) for (u = n.slice(1).split("&"), i = 0; i < u.length; i++) r = u[i].split("="), f = r[0].toLowerCase(), /(theme|q|country|currency|tzoff|PartnerId|IsSingleWallet|mc|allowracing|reg)/i.test(f) || (e = t === "" ? "?" : "&", t = t + e + f + "=" + r[1]);
				return t
			},
			o = function(t, i) {
				n({
